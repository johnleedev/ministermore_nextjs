...
export default function RecruitChurchDetail ({ params }: { params: { id: string } }) {
  ...
  const fetchPosts = async () => {
    const res = await axios.post(`${MainURL}/api/recruitchurch/getrecruitdatapart`, {
      id : ID
    })
    if (res.data) {
